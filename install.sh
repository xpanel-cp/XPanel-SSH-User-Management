...
echo -e "${GREEN}  1)XPanel v3.8.3"
echo -e "${GREEN}  2)XPanel v3.8.2"
echo -e "${GREEN}  3)XPanel v3.8.1"
echo -e "${GREEN}  4)XPanel v3.8.0"
echo -e "${GREEN}  5)XPanel v3.7.9"
echo -e "${GREEN}  6)XPanel v3.7.8"
echo -e "${GREEN}  7)XPanel v3.7.7"
echo -e "${GREEN}  8)XPanel v3.7.6"
