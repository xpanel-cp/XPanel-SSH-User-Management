...
wellcomeINSTALL() {
  ...
  echo -e "${GREEN}  2)XPanel v3.9.6"
  echo -e "${GREEN}  3)XPanel v3.9.4"
  echo -e "${GREEN}  4)XPanel v3.9.1"
  echo -e "${GREEN}  5)XPanel v3.8.7"
  echo -e "${GREEN}  6)XPanel v3.8.6"
  echo -e "${GREEN}  7)XPanel v3.8.5"
