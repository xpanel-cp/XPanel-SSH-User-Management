                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <select class="form-select" data-gtm-form-interact-field-id="0" disabled>
                                                            <option @if($show->protocol_sb=='vmess-ws') selected @endif>VMess ws</option>
                                                            <option @if($show->protocol_sb=='vless-reality') selected @endif>VLess Reality</option>
                                                            <option @if($show->protocol_sb=='hysteria2') selected @endif>Hysteria2</option>
                                                            <option @if($show->protocol_sb=='tuic') selected @endif>Tuic</option>
                                                        </select>
