                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <form action="{{route('settings.ipadapter.update')}}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-lg-3">
                                                    <input type="text" name="email" class="form-control" value="{{ optional($ipadapter[0])->email_cf }}" placeholder="mail@example.com" required>
                                                    <small>{{__('ip-adapter-change-email-cf')}}</small>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        <input type="text" name="token" class="form-control" value="{{ optional($ipadapter[0])->token_cf }}">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <input type="text" name="sub" class="form-control" value="{{ optional($ipadapter[0])->sub_cf }}" placeholder="sub.example.com">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="border card p-3">
                                                                    <div class="form-check">
                                                                        <input type="radio" name="change" value="hourly" class="form-check-input input-primary" id="customCheckdef1" data-gtm-form-interact-field-id="1" @if(optional($ipadapter[0])->status_chanched == 'hourly') checked @endif>
                                ...
                                <span class="f-12 text-muted">
                                  {{__('ip-adapter-change-hourly-desc')}}
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="border card p-3">
                                                                    <div class="form-check">
                                                                        <input type="radio" name="change" value="traffic" class="form-check-input input-primary" id="customCheckdef2" data-gtm-form-interact-field-id="1"  @if(optional($ipadapter[0])->status_chanched == 'traffic' || empty($ipadapter[0]->status_chanched)) checked @endif >
                                ...
                                <span class="f-12 text-muted">
                                  {{__('ip-adapter-change-traffic-desc')}}
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="border card p-3">
                                                                    <div class="form-check">
                                                                        <input type="radio" name="change" value="filter" class="form-check-input input-primary" id="customCheckdef3" data-gtm-form-interact-field-id="1" @if(optional($ipadapter[0])->status_chanched == 'traffic') checked @endif >
                                ...
                                <span class="f-12 text-muted">
                                  {{__('ip-adapter-change-filtering-desc')}}
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="status_service" value="on" id="flexRadioDefault11" @if(optional($ipadapter[0])->status_active == 'on' || empty($ipadapter[0]->status_active)) checked @endif >
                                                        <label class="form-check-label" for="flexRadioDefault11"> {{__('dashboard-active-user')}} </label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="status_service" value="off" id="flexRadioDefault12" @if($ipadapter[0]->status_active == 'off') checked @endif >
